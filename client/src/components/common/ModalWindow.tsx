...
export const ModalWindow = ({ active, children }: ModalFormProps) => {
    return (
        <div className={
            active
                ? "flex items-center justify-center fixed w-screen h-screen top-0 left-0 bg-black/[.30] backdrop-blur-sm opacity-100 pointer-events-auto duration-500"
